...
const steps = [
  ...
  "actions": [
    ...
    },
    {
        number: "04",
        title: "Test & Enable",
        content: "Before enabling a rule, use the built-in test mode to simulate file events. Drop a test file into your watched directory and verify the rule executes correctly.",
        code: null,
        note: "Test mode creates a temporary sandbox — no files are actually moved or modified until you enable the rule.",
    },
    {
        number: "05",
        title: "Monitor & Refine",
        content: "Once enabled, monitor your rules from the dashboard. View execution logs, success rates, and processing times. Refine your conditions to handle edge cases.",
        code: null,
